...
public class Constants {
	...
	public static class Enviroment {
		...
		public static final int BIG_CLOUD_WIDTH = (int)(BIG_CLOUDS_WIDTH_DEFAULT * Game.SCALE);
		public static final int BIG_CLOUD_HEIGHT = (int)(BIG_CLOUDS_HEIGHT_DEFAULT * Game.SCALE);
		
		public static final int SMALL_CLOUD_WIDTH = (int)(SMALL_CLOUDS_WIDTH_DEFAULT * Game.SCALE);
		public static final int SMALL_CLOUD_HEIGHT = (int)(SMALL_CLOUDS_HEIGHT_DEFAULT * Game.SCALE);
	}
